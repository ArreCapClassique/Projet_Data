...
SELECT
    ...
    COUNT(*) AS nb_total,
    COUNT(*) FILTER (WHERE ann_soin = 0) AS nb_unutilisable,
    ROUND(nb_unutilisable / nb_total, 6) AS pct_unutilisable
FROM stg.transactions
UNION ALL
SELECT
    'age' AS column_name,
    COUNT(*) AS nb_total,
    COUNT(*) FILTER (WHERE ann_soin = 99) AS nb_unutilisable,
    ROUND(nb_unutilisable / nb_total, 6) AS pct_unutilisable
FROM stg.transactions
UNION ALL
SELECT
...
SELECT
    ...
    COUNT(*) AS nb_total,
    COUNT(*) FILTER (WHERE ann_soin IN (0, 99)) AS nb_unutilisable,
    ROUND(nb_unutilisable / nb_total, 6) AS pct_unutilisable
FROM stg.transactions
UNION ALL
SELECT
    ...
    COUNT(*) AS nb_total,
    COUNT(*) FILTER (WHERE ann_soin IN (9, 98)) AS nb_unutilisable,
    ROUND(nb_unutilisable / nb_total, 6) AS pct_unutilisable
FROM stg.transactions
UNION ALL
SELECT
...
SELECT
    ...
    COUNT(*) AS nb_total,
    COUNT(*) FILTER (WHERE ann_soin = 9) AS nb_unutilisable,
    ROUND(nb_unutilisable / nb_total, 6) AS pct_unutilisable
FROM stg.transactions
UNION ALL
SELECT
...
SELECT
    ...
    COUNT(*) AS nb_total,
    COUNT(*) FILTER (WHERE ann_soin IN (8, 9)) AS nb_unutilisable,
    ROUND(nb_unutilisable / nb_total, 6) AS pct_unutilisable
FROM stg.transactions
